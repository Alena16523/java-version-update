...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        //summingInt(ToIntFunction) : returns a Collector that produces the sum of a Integer-values func
        ...
        //averagingInt(tToIntFunction): returns the average of the integers passed values
